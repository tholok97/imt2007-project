...
% * Physical hardening
% * config as appendix
% * delete risk about natural disaster at branch
% * flavortext about ict section
% * update diagram section
% * skim through WAN section
...
\notetous{Show logical and physical views, and provide some discussion around them. The diagrams included are only temporary, proper ones will be added later.}
