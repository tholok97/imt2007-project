...
\notetous{See comments for structure of this section}

\subsection{Unauthorized access to confidential data}
\textbf{Description}: We may store information about our partners and others we offer services to. This data can be discovered security flaws or other compromising information. Meanwhile, the information vital for our organization to perform our services. Unauthorized individuals may try to steal or view this information.

\textbf{Impact}: Our organization rely on our reputation. Therefore, the impact of losing confidential information is critical.

\textbf{Likelyhood}: As this information is one of our most important assets, it is a target for people with mischievous intent. Before 

\textbf{Verdict}: Access to confidential data must be secured with AAA and logged. It must be stored encrypted on a safe server. In precessing is must also be encrypted and never be transferred over unsecured links in plaintext.
...
\subsection{Ernst pointing out a major flaw in our infrastructure}

\textbf{Description}: Ernst has immense power over us as students, and will give feedback on our infrastructure during the presentation.

\textbf{Impact}: Loss of confidence and will to live. If Ernst isn't happy we aren't happy.

\textbf{Likelyhood}: The likelyhood is increasing, as Johannes is working hard on making our setup presentable.

\textbf{Verdict}: There's not much we can do about this, other than to hope and pray for a happy Ernst.
...
\centering
\includegraphics[width=\textwidth]{logicalviewtemp}
\label{logicalview}
\end{figure}
...
\notetous{Discuss our demo PT implementation, with a special note about what we did for wireless. refer to appendix.}
